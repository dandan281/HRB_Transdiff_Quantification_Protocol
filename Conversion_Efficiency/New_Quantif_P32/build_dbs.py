"""Build the background-subtracted Desmin cache for PLATE_32 (raw camera units).
Identical preprocessing to the other plates: white top-hat (disk r=40) on the raw
Desmin channel, kept in RAW units, cached as uint16.

Run from Conversion_Efficiency/:
    cpenv/Scripts/python.exe New_Quantif_P32/build_dbs.py
"""
...
ND2_DIR = "../Q_PLATES/Q_Plates/PLATE_32"
