"""Build the background-subtracted Desmin cache for PLATE_28 (raw camera units).
Identical preprocessing to New_Quantif_P26/build_dbs.py: white top-hat (disk r=40)
on the raw Desmin channel, kept in RAW units, cached as uint16.

Run from Conversion_Efficiency/:
    cpenv/Scripts/python.exe New_Quantif_P28/build_dbs.py
"""
...
ND2_DIR = "../Q_PLATES/Q_Plates/PLATE_28"
